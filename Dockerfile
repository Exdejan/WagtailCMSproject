...
CMD set -xe; ls -la /app/home/static/css/; python manage.py collectstatic --noinput --verbosity 2; python manage.py migrate --noinput; gunicorn CMS.wsgi:application --bind 0.0.0.0:8080