...
CMD set -xe; find /app -name "*.css" | head -20; python manage.py collectstatic --noinput; python manage.py migrate --noinput; gunicorn CMS.wsgi:application --bind 0.0.0.0:8080